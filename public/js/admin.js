...
// // let row = ('<tr><th>"Col1"</th><th>"Col2"</th><th>"Col3"</th> </tr>');  
// // console.log(row);
...
// //     let messageList = $(".table tbody");
// //     let messageContainer = $("#admin")
...
// //         messageList.children().not(":last").remove();
// //         messageContainer.children(".alert").remove();
// //         if (rows.length) {
// //           console.log(rows);
...
// //         newTr.append("<td>" + nameInput + "</td>");
// //         newTr.append("<td>" + emailInput + "</td>");
// //         newTr.append("<td>" + messageInput + "</td>");
// //         // newTr.append("<td> " + messageData.Posts.length + "</td>");
// //         newTr.append("<td><a style='cursor:pointer;color:red' class='delete-message'>Delete message</a></td>");
// //         // console.log(newTr);
// //         return newTr;
// //       }
    
// //     //   function handleDeleteButtonPress() {
// //     //     var listItemData = $(this).parent("td").parent("tr").data("message");
...
//         database.ref().remove(function(error) {
